...
CREATE TABLE IF NOT EXISTS sources (
    ...
    last_successful_sync DOUBLE PRECISION,
    next_sync_at DOUBLE PRECISION,
...
CREATE TABLE IF NOT EXISTS documents (
    ...
    first_discovered_at DOUBLE PRECISION NOT NULL,
    last_discovered_at DOUBLE PRECISION NOT NULL,
...
CREATE TABLE IF NOT EXISTS document_revisions (
    ...
    data_revision_id TEXT NOT NULL DEFAULT '',
    staging_release_id TEXT NOT NULL DEFAULT '',
    created_at DOUBLE PRECISION NOT NULL,
...
ON sync_runs(source_id) WHERE current_state IN ('running','retrying');
...
CREATE TABLE IF NOT EXISTS deletion_jobs (
    ...
    revision_id TEXT,
    idempotency_key TEXT NOT NULL UNIQUE,
    state TEXT NOT NULL CHECK(state IN ('detected','tombstoned','propagating','verified','completed','failed')),
